  ...
  <div class="container h-100">
    ...
    <div class="d-flex flex-column">
      ...
      <div class="d-flex justify-content-between align-items-center sticky-md-top bgCustom flex-column flex-md-row"
        ...
        <div style="width: 100%;">
          {{-- Top Navbar --}}
          <div class="d-flex justify-content-between align-items-center flex-column flex-md-row" style="height: 100%;">
            ...
            <div style="width: 200px;" class="flex-shrink-0">
              <form action="/search" method="POST">
                @csrf
                  <meta name="csrf-token" content="{{ csrf_token() }}">
                <input id="search" class="form-control rounded-pill" type="text" placeholder="{{__('Cari...')}}"
                  aria-label="Search" name="keyword" id="keyword" style="max-width: 100%;">
              </form>
            </div>
            {{-- Dropdown Avatar --}}
            <div class="d-flex align-items-center flex-column flex-md-row">
              ...
              @auth
              <div class="dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuButton" type="button" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="true">
                  @if (Auth::user()->profile->profile_pic)
                  <img src="{{ url('images/' . Auth::user()->profile->profile_pic) }}" width="40" height="40"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuButton"
                  ...
                  <a class="dropdown-item" href="/user/{{Auth::user()->id}}">{{__('Profil')}}</a>
                  <a class="dropdown-item" href="/user/{{Auth::user()->id}}/tukar-kata-laluan">{{__('Tukar Kata Laluan')}}</a>
              ...
              <div class="d-flex justify-content-between mb-2 m-md-0">
                ...
                <a href="/register" class="mx-1 btn btn-outline-primary">{{__('Buat Akaun')}}</a>
              </div>
              @endauth
              @endif
            </div>
