...
<div class="m-4">
    <div class="row">
        <nav>
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/vendor/{{ $vendor->id }}" class="text-capitalize">{{ $vendor->nama_pembekal_dilantik }}</a></li>
                <li>Edit</li>
              </ul>
          </nav>
    </div>
    ...
    <form action="/admin/vendor/{{ $vendor->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
                ...
                <div class="row my-4">
                    <div class="mx-auto image___container">
                        ...
                        <img src="{{ url('images/' . $vendor->vendor_profile->vendor_avatar) }}"
                            class="rounded mx-auto d-block rounded-circle image___profilepic" alt="..." style="width: 200px; height: 200px;" id="output">
                        @else
                        <img src="https://picsum.photos/200"
                            class="rounded mx-auto d-block rounded-circle image___profilepic" alt="..." style="width: 200px; height: 200px;" id="output">
                        @endif
                        <div class="middle">
                            <input id="upload" type="file" name="image" accept="image/png, image/gif, image/jpeg" value="{{ $vendor->vendor_profile->vendor_avatar }}"
            ...
            <div class="col-xs-12 col-md-9 my-4 p-4">
                <div class="card card-body p-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8"><input class="form-control" type="text" name="nama_pembekal"
                                value="{{ $vendor->nama_pembekal_dilantik }}"></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-4"><label class="form-label" for="description">Description</label></div>
                        <div class="col-8"><textarea class="form-control" name="description" id="mytextarea" cols="30"
                                rows="15">{{ $vendor->description }}</textarea></div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8"><input class="form-control" type="text" name="no_telefon"
                                value="{{ $vendor->vendor_profile->telefon }}"></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-4"><label class="form-label" for="faks">Faks</label></div>
                        <div class="col-8"><input class="form-control" type="text" name="faks"
                                value="{{ $vendor->vendor_profile->faks }}"></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-4"><label class="form-label" for="alamat">Alamat Pejabat</label></div>
                        <div class="col-8"><input class="form-control" type="text" name="alamat"
                                value="{{ $vendor->vendor_profile->alamat }}"></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-4"><label class="form-label" for="website">Laman Web</label></div>
                        <div class="col-8"><input class="form-control" type="text" name="website"
                                value="{{ $vendor->vendor_profile->website }}"></div>
                    </div>
                    <div class="row mb-3">
