    ...
    <div class="row">
        <nav>
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/projek/{{ $project->id }}" class="text-capitalize">{{ $project->tajuk_projek }}</a></li>
                <li>Edit</li>
              </ul>
          </nav>
    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-4">
                                    <input type="text" id="kos_projek_sebelum_sst" name="kos_projek_sebelum_sst"
                                        class="form-control" value="{{ $project->kos_projek_sebelum_sst }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-4">
                                    <input type="text" id="kos_projek_selepas_sst" name="kos_projek_selepas_sst"
                                        class="form-control" value="{{ $project->kos_projek_selepas_sst}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <select name="status" id="status" class="form-control">
                                        <option value="aktif" @if($project->status === 'aktif') selected @endif>Aktif</option>
                                        <option value="tidak aktif" @if($project->status === 'tidak aktif') selected @endif>Tidak Aktif</option>
                                        <option value="selesai" @if($project->status === 'selesai') selected @endif>Selesai</option>
                                      </select>
                                </div>
                            </div>
                        </div>
