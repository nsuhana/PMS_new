            ...
            <div class="row">
                <div class="col-12">
                    <div class="container px-0 m-0 d-flex justify-content-between align-items-center">
                        <h4>Select project to restore</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-capitalize">{{$projek->tajuk_projek}}</div>
                                </td>
                                <td>
                                    <span>{{$projek->deleted_at}}</span>
                                </td>
                                <td style="width:auto">
                                    <div class="d-flex align-items-center">
                                        <form action="/admin/projek/{{$projek->id}}/restore" method="POST">
                                            @csrf
                                            @method('put')
                                            <button type="submit" class="btn btn-primary btn-sm">Restore</button>
                                        </form>
                                        <form action="/admin/projek/{{$projek->id}}/permanent-delete" method="POST">
                                            @csrf
                                            @method('put')
