...
<div class="shadow card mt-3"
    ...
    <div class="card-header d-flex align-items-center">
        <h3>{{__('Edit Kandungan')}}</h3>
        <small class="mx-3">{{ $projek->tajuk_projek }}</small>
    </div>
    <form action="/projek/{{ $projek->id }}/kandungan/{{ $kandungan->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-12">
                    <input type="text" class="form-control" id="tajuk_besar" name="tajuk_besar" value="{{ $kandungan->tajuk_besar }}">
                </div>
            </div>
                ...
                <div class="col-md-8 col-12">
                    <div class="d-flex flex-column flex-md-row">
                        <div class="form-group mx-2 mx-md-0">
                            ...
                            @if ($kandungan->card_view->staff === 1)
                            checked
                            @endif>
                        ...
                        <div class="form-group mx-2">
                            ...
                            class="form-check-input"
                            @if ($kandungan->card_view->editor === 1)
                            checked
                            @endif>
                        ...
                        <div class="form-group mx-2">
                            ...
                            class="form-check-input" 
                            @if ($kandungan->card_view->normal_user === 1)
                            checked
                            @endif>
                        ...
                        <div class="form-group mx-2">
                            ...
                            class="form-check-input"
                            @if ($kandungan->card_view->guest === 1)
                            checked
                            @endif>
