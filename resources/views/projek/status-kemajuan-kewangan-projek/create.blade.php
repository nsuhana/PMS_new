<tr>
    <td>
        <input class="edit__input form-control input__tahun" type="text" value="" maxlength="4"
    ...
    <td>
        <div class="d-flex align-items-center currency">RM&nbsp;
            <input class="edit__input form-control" type="number" value="" maxlength="12"
                size="12" id="nilai_kontrak" name="nilai_kontrak">
        </div>
    </td>
    <td>
        <div class="d-flex align-items-center currency">RM&nbsp;
            <input class="edit__input form-control" type="number" value=""
                maxlength="12" size="12" id="jadual_tuntutan" name="jadual_tuntutan">
        </div>
    </td>
    <td>
        <div class="d-flex align-items-center currency">RM&nbsp;
    ...
    <td>
        <input class="edit__input form-control date" style="width: 140px;" type="date" value=""
    ...
    <td>
        <div class="d-flex mx-1">
            ...
            <button onClick="cancelCreate()" class="btn btn-outline-secondary" style="font-size: 12px;">Cancel</button>
            <button class="btn_save btn btn-outline-primary ms-1" style="font-size: 5px;"
                onClick="store()">
