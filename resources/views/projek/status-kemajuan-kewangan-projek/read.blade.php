@if ($kewangnan->isEmpty())
    <tr>
        <th colspan="100%">No data...</th>
    </tr>
@else
@foreach ($kewangnan as $kewangan)
<tr row_id="{{ $kewangan->id }}">
    <td>
    ...
    <td>
        <div class="d-flex mx-1">
            ...
            <button onClick="destroy({{ $kewangan->id }})" class="btn_delete btn btn-outline-danger ms-1" style="font-size: 5px;">
