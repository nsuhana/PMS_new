    ...
    <div class="row">
      <form action="/projek" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-8 col-12">
            <div class="row mb-3">
              ...
              <div class="col-md-4 col-6">
                <input type="number" id="kos_projek_sebelum_sst" name="kos_projek_sebelum_sst" class="form-control" step=".01">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 col-6">
              ...
              <div class="col-md-4 col-6">
                <input type="number" id="kos_projek_selepas_sst" name="kos_projek_selepas_sst" class="form-control" step=".01">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-8 col-12">
            <input type="number" id="bon_pelaksanaan_projek" name="bon_pelaksanaan_projek" class="form-control" step=".01">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-8 col-12">
            <div class="row">
              <div class="col-6">
                <label for="tempoh_mula_kontrak" class="form-label">{{__('Tarikh Mula')}}</label>
                <input type="date" name="tempoh_mula_kontrak" id="tempoh_mula_kontrak" class="form-control mt-2">
              </div>
              <div class="col-6">
                <label for="tempoh_tamat_kontrak" class="form-label">{{__('Tarikh Tamat')}}</label>
                <input type="date" name="tempoh_tamat_kontrak" id="tempoh_tamat_kontrak" class="form-control mt-2">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-8 col-12">
            <div class="form-group">
              <input class="form-check-input" type="radio" name="skop_projek" id="Pembekalan" value="pembekalan" checked>
              <label class="form-check-label" for="Pembekalan">
                {{__('Pembekalan')}}
              </label>
            </div>
            <div class="form-group my-2">
              <input class="form-check-input" type="radio" name="skop_projek" id="perkhidmatan" value="perkhidmatan">
        ...
        <div class="d-flex">
          ...
          <div class="col-2 fill">
            <button class="btn btn-primary" style="width: 100%;" type="submit">{{__('Simpan')}}</button>
          </div>
        </div>
