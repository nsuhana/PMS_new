...
@section('content')
    ...
    <div class="card mb-3 pb-2"
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <a href="/projek/create"
                    class="text-primary text-small text-decoration-none">{{ __('Tambah Projek Baru') }}<svg
            ...
            <div class="col-auto">
                ...
                <div class="dropdown">
                    <a class="btn btn-dark dropdown-toggle d-flex align-items-center justify-content-between" href="#"
                        id="toggleFilter" role="button" data-toggle="dropdown" style="width: 200px;" aria-haspopup="true"
                        aria-expanded="false">
                        <span>
                            ...
                            <div class="mt-2 d-flex flex-column">
                                ...
                                <div class="mx-2">
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_ownership"
                                            id="filter_ownership1" value=""
                                            @if ($filter_ownership === null) checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_ownership"
                                            id="filter_ownership2" value="owner"
                                            @if ($filter_ownership === 'owner') checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_ownership"
                                            id="filter_ownership3" value="editor"
                                            @if ($filter_ownership === 'editor') checked @endif>
                                ...
                                <div class="mx-2">
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_status"
                                            id="filter_projek_status1" value=""
                                            @if ($filter_projek_status === null) checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_status"
                                            id="filter_projek_status2" value="ikut jadual"
                                            @if ($filter_projek_status === 'ikut jadual') checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_status"
                                            id="filter_projek_status3" value="dalam perlaksanaan"
                                            @if ($filter_projek_status === 'dalam perlaksanaan') checked @endif>
                                        <label class="form-check-label mx-2" for="filter_projek_status3">
                                            {{ __('Dalam Perlaksanaan') }}
                                        </label>
                                    </div>
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_status"
                                            id="filter_projek_status4" value="projek lewat"
                                            @if ($filter_projek_status === 'projek lewat') checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                      <input class="form-check-input" type="radio" name="filter_projek_status"
                                          id="filter_projek_status5" value="projek sakit"
                                          @if ($filter_projek_status === 'projek sakit') checked @endif>
                                ...
                                <div class="mx-2">
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_skop"
                                            id="filter_projek_skop1" value=""
                                            @if ($filter_projek_skop === null) checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_skop"
                                            id="filter_projek_skop2" value="pembekalan"
                                            @if ($filter_projek_skop === 'pembekalan') checked @endif>
                                    ...
                                    <div class="form-label m-0">
                                        <input class="form-check-input" type="radio" name="filter_projek_skop"
                                            id="filter_projek_skop3" value="perkhidmatan"
                                            @if ($filter_projek_skop === 'perkhidmatan') checked @endif>
                            ...
                            <div class="row align-items-center">
                                <div class="col-6 ps-card">
                                    <a class="text-decoration-none text-capitalize"
                                        href="/projek/{{ $project->id }}">{{ $project->tajuk_projek }}</a>
                                    <br>
                                    ...
                                    @if ($project->editor_comment->isNotEmpty())
                                        <div class="progress" style="height:5px;">
                                            <div class="progress-bar"
                                                style="width: {{ $project->editor_comment->last()->peratus_siap }}%;"
                                                role="progressbar"
                                                aria-valuenow="{{ $project->editor_comment->last()->peratus_siap }}"
                                                aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="small">
                                            <strong>{{ $project->editor_comment->last()->peratus_siap }}</strong>%
                                            {{ __('siap') }}</div>
                                    @else
                                        <div class="progress" style="height:5px;">
                                ...
                                <div class="col-1">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="navbarDropdownMenuLink" style="right: 0">
                                            <a class="dropdown-item"
                                                href="/projek/{{ $project->id }}">{{ __('Lanjut') }}</a>
