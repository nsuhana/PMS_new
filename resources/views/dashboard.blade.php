...
<div class="d-flex flex-column">
    ...
    <div class="d-flex align-items-center justify-content-between mb-2" style="height: 200px;">
        <div class="w-100 d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <h3 class="count2">{{$jumlah_projek}}</h3>
        </div>
        <div class="vr my-3"></div>
        <div class="w-100 d-flex flex-column align-items-center justify-content-center text-center">
            <span>{{__('Jumlah Projek Selesai')}}</span>
            <h3 class="count2">{{$jumlah_projek_selesai}}</h3>
        </div>
    </div>
    {{-- 2nd row --}}
    <div class="d-flex flex-md-row flex-column align-items-center justify-content-between mb-4">
        <div class="card shadow p-5 mx-2 mb-2 mb-md-0" style="width: 100%; height: 150px;">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                    <span>{{__('Pembekal Dilantik')}}</span>
                    <h5 class="count2">{{$jumlah_pembekal}}</h5>
                </div>
            </div>
        </div>
        <div class="card shadow p-5 mx-2 mb-2 mb-md-0" style="width: 100%; height: 150px;">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <h5><span class="mx-1">RM</span><span class="count">{{$jumlah_telah_dibayar}}</span></h5>
                </div>
            </div>
        </div>
        <div class="card shadow p-5 mx-2 mb-2 mb-md-0" style="width: 100%; height: 150px;">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <h5><span class="mx-1">RM</span><span class="count">{{$jumlah_nilai_kontrak}}</span></h5>
                </div>
            </div>
        </div>
        <div class="card shadow p-5 mx-2 mb-2 mb-md-0" style="width: 100%; height: 150px;">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <h5><span class="mx-1">RM</span><span class="count">{{$jumlah_bon}}</span></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-column">
                    <div class="d-flex justify-content-end">
                        <select name="" id="btn__sorter" class="form-select" onChange="read()" style="width: 150px; padding-left: 9px; padding-right: 27px; background-position: right 0.75rem center !important;">
  ...
  <div class="card shadow mx-2 mb-2 mb-md-0 flex-fill d-none d-md-block">
            <div class="card-body" style="width: 216px">
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-center w-100 my-2">
                        ...
                        <div role="progressbar" aria-valuenow="{{$random_projek->editor_comment->last()->peratus_siap}}" aria-valuemin="0" aria-valuemax="100" style="--value:{{$random_projek->editor_comment->last()->peratus_siap}}">
                        </div>
                        @else
                    ...
                    <div class="d-flex justify-content-center w-100">
                        @if ($random_projek->editor_comment->isNotEmpty())
                        <h6 class="text-capitalize">{{$random_projek->editor_comment->last()->fasa_sekarang}}</h6>
                        @else
            ...
            <div class="card-footer d-flex justify-content-center">
                <a href="/projek/{{$random_projek->id}}" class="text-decoration-none small">{{__('Lanjut')}}</a>
            </div>
        </div>
    </div>
    ...
    {{-- 4th row --}}
    <div class="d-flex align-items-stretch justify-content-between mb-2 flex-column flex-md-row">
        <div class="card shadow mx-2 mb-2 mb-md-0 flex-md-fill d-none d-md-block">
            <div class="card-body">
                <div id="chart"></div>
            </div>
        </div>
        <div class="card shadow mx-2 flex-fill mb-2 mb-md-0 d-none d-md-block">
            <div class="card-header">{{__('Projek')}}</div>
            <div class="card-body pt-0 pb-0">
                @foreach ($projects as $projek)
                <div class="row g-0 align-items-center py-2 position-relative border-bottom border-200">
                    <div class="col-10 ps-card">
                        <a class="text-decoration-none" href="/projek/{{$projek->id}}">{{$projek->tajuk_projek}}</a>
                        <br>
