    ...
    <div class="row">
        @foreach ($results as $result)
            <div class="col-xs-12 col-sm-6 col-md-4 my-2">
                <div class="shadow-sm card card-body" style="min-height: 140px; max-height: 200px; cursor: pointer;"
                        ...
                        <div class="d-flex flex-column" style="margin-top: auto">
                            ...
                            @if ($result->status === 'ikut jadual')
                                <span class="badge rounded-pill"
                                    style="margin-top: auto; background-color: #2684C4;">Ikut Jadual</span>
                            @elseif ($result->status === 'dalam perlaksanaan')
                                <span class="badge rounded-pill"
                                    style="margin-top: auto; color: black; background-color: #9BCC5C">Dalam
                                    Perlaksanaan</span>
                            @elseif ($result->status === 'projek lewat')
                                <span class="badge rounded-pill"
                                    style="margin-top: auto; color: black; background-color: rgb(241, 114, 91)">Projek
                                    Lewat</span>
                            @elseif ($result->status === 'projek sakit')
                                <span class="badge rounded-pill bg-secondary" style="margin-top: auto;">Projek
                                    Sakit</span>
                            @else
